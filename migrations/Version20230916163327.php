 ...
 */
final class Version20230916163327 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE project (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(150) NOT NULL, description VARCHAR(1000) NOT NULL, duration VARCHAR(20) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', github VARCHAR(255) DEFAULT NULL, picture VARCHAR(255) NOT NULL, video VARCHAR(255) DEFAULT NULL, updated_at DATETIME DEFAULT NULL, commits INT DEFAULT NULL, mockup VARCHAR(255) DEFAULT NULL, link VARCHAR(255) DEFAULT NULL, github_languages LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
